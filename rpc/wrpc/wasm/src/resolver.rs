//! [`Resolver`](NativeResolver) bindings for obtaining public Calico wRPC URL endpoints.

#![allow(non_snake_case)]

use crate::client::{RpcClient, RpcConfig};
use crate::imports::*;
pub use calico_rpc_macros::declare_typescript_wasm_interface as declare;
use calico_wrpc_client::node::NodeDescriptor;
use calico_wrpc_client::Resolver as NativeResolver;
use js_sys::Array;
use serde::ser;
...
///
/// Resolver is a client for obtaining public Calico wRPC URL.
///
/// Resolver queries a list of public Calico Resolver URLs using HTTP to fetch
...
#[wasm_bindgen]
impl Resolver {
    /// List of public Calico Resolver URLs.
    #[wasm_bindgen(getter)]
    ...
    /// Fetches a public Calico wRPC endpoint for the given encoding and network identifier.
    ...
    /// Fetches a public Calico wRPC endpoint URL for the given encoding and network identifier.
    ...
    /// Connect to a public Calico wRPC endpoint for the given encoding and network identifier
