...
use calico_consensus_core::hashing::*;
use calico_consensus_core::hashing::sighash_type::{SigHashType, SIG_HASH_ALL};
use calico_consensus_core::subnets::SUBNETWORK_ID_NATIVE;
use calico_consensus_core::tx::{TransactionOutpoint, TransactionOutput, VerifiableTransaction};
// use calico_hashes::{Hash, Hasher, HasherBase, TransactionSigningHash};
...
use calico_hashes::{Hash, Hasher, HasherBase, TransactionSigningHash, TransactionSigningHashECDSA, ZERO_HASH};
use calico_consensus_core::hashing::HasherExtensions;
use calico_consensus_core::hashing::sighash::*;
