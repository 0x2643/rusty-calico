...
## Sequential processing flow (in go-calicod)

Below we detail the current state of affairs in *go-calicod* and
...
The current code design (*go-calicod*) already logically supports this since the various processing stages were already decoupled for supporting efficient IBD.
