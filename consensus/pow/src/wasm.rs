...
use calico_consensus_client::Header;
use calico_consensus_client::HeaderT;
use calico_consensus_core::hashing;
use calico_hashes::Hash;
use calico_hashes::PowHash;
use calico_math::Uint256;
use calico_utils::hex::FromHex;
...
/// Represents a Calico header PoW manager
/// @category Mining
