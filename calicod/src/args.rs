...
use calico_core::calicod_env::version;
use calico_notify::address::tracker::Tracker;
use calico_utils::networking::ContextualNetAddress;
use calico_wrpc_server::address::WrpcNetAddress;
...
#[cfg(feature = "devnet-prealloc")]
use calico_consensus_core::tx::{TransactionOutpoint, UtxoEntry};
#[cfg(feature = "devnet-prealloc")]
...
impl Args {
    ...
    #[cfg(feature = "devnet-prealloc")]
    pub fn generate_prealloc_utxos(&self, num_prealloc_utxos: u64) -> calico_consensus_core::utxo::utxo_collection::UtxoCollection {
...
pub fn cli() -> Command {
    ...
    let cmd = Command::new("calicod")
        .about(format!("{} (rusty-calico) v{}", env!("CARGO_PKG_DESCRIPTION"), version()))
...
/*
  ...
  -a, --addpeer=                            Add a peer to connect with at startup
      ...
      --rpccert=                            File containing the certificate file (default:
                                            /Users/aspect/Library/Application Support/Calicod/rpc.cert)
      --rpckey=                             File containing the certificate key (default:
                                            /Users/aspect/Library/Application Support/Calicod/rpc.key)
