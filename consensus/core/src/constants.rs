...
/// SompiPerCalico is the number of sompi in one calico (1 SPR).
pub const SOMPI_PER_CALICO: u64 = 100_000_000;

/// The parameter for scaling inverse SPR value to mass units (KIP-0009)
pub const STORAGE_MASS_PARAMETER: u64 = SOMPI_PER_CALICO * 10_000;

/// MaxSompi is the maximum transaction amount allowed in sompi.
pub const MAX_SOMPI: u64 = 1_161_000_000 * SOMPI_PER_CALICO;
