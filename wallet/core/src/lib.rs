...
//! <https://calico.aspectron.org/docs/>
//!
...
//! <https://aspectron.org/en/projects/calico-wasm.html>
//!
...
//! the `calico` module includes `websocket` module dependency simulating
...
extern crate alloc;
extern crate self as calico_wallet_core;
...
pub fn version_with_git_hash() -> String {
    calico_utils::git::with_short_hash(env!("CARGO_PKG_VERSION")).to_string()
}
