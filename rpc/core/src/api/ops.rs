...
pub enum RpcApiOps {
    ...
    GetSyncStatus = 115,
    /// Returns the network this Calicod is connected to (Mainnet, Testnet)
    ...
    /// Returns a list of all the addresses (IP, port) this Calicod knows and a list of all addresses that are currently banned by this Calicod
    ...
    /// Returns a list of the peers currently connected to this Calicod, along with some statistics on them
    GetConnectedPeerInfo = 123,
    /// Instructs Calicod to connect to a given IP address.
    AddPeer = 124,
