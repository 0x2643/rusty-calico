        ...
        match command.as_str() {
            ...
            "legacy" => {
                if exists_legacy_v0_keydata().await? {
                    ...
                    return Err("Calico Desktop/web wallet keydata file not found".into());
                }
            }
            // todo "read-only" => {}
            // "core" => {}
