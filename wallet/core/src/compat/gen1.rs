...
mod test {
    ...
    async fn import_golang_single_wallet_test() {
        ...
        let file = SingleWalletFileV1{
            encrypted_mnemonic: EncryptedMnemonic {
                cipher: hex!("").as_slice(),
                salt: hex!("6f7f62545649649e326626bbee957e4d").as_slice(),
            },
            xpublic_key: "kpub2JHxRuDEPzKKGVF8mm9kmVXY9348wKzgBNwjAkSaenBev5oAqhc2u1nyoadZKbdxSGJMMpHspg6zAgPt94M8YvxK2JMrTWxmoDqiw3sV36Y",
            ecdsa: false,
        };
        let import_secret = Secret::new(vec![]);

        let acc = wallet.import_calicowallet_golang_single_v1(&import_secret, &wallet_secret, file).await.unwrap();
        assert_eq!(
            acc.receive_address().unwrap(),
            Address::try_from("calico:qq6jsada229stekqalz0n3qmepld0l070880nuq437qsaecvatcpczay9mp6t").unwrap(), // taken from golang impl
        );
    }
    ...
    async fn import_golang_multisig_v1_wallet_test() {
        ...
        let acc = wallet.import_calicowallet_golang_multisig_v1(&import_secret, &wallet_secret, file).await.unwrap();
        assert_eq!(
            acc.receive_address().unwrap(),
            Address::try_from("calico:pqla9lqhcm05cpj0g4ukv06u2f5jr7zw43a3rx3mtkawjyg25d2sgr6kcp3kn").unwrap(), // taken from golang impl
        );
    }
    ...
    fn deser_golang_wallet_test() {
        ...
        struct EncryptedMnemonicIntermediate {
            #[serde(with = "calico_utils::serde_bytes")]
            cipher: Vec<u8>,
            #[serde(with = "calico_utils::serde_bytes")]
            salt: Vec<u8>,
        }
