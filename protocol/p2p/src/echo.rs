use crate::{
    ...
    handshake::CalicodHandshake,
    pb::{self, VersionMessage},
    CalicodMessagePayloadType, IncomingRoute, Router,
};
use calico_core::{debug, time::unix_now, trace, warn};
use std::sync::Arc;
...
impl EchoFlow {
    pub async fn register(router: Arc<Router>) {
        ...
        let receiver = router.subscribe(vec![
            CalicodMessagePayloadType::Addresses,
            CalicodMessagePayloadType::Block,
            CalicodMessagePayloadType::Transaction,
            CalicodMessagePayloadType::BlockLocator,
            CalicodMessagePayloadType::RequestAddresses,
            CalicodMessagePayloadType::RequestRelayBlocks,
            CalicodMessagePayloadType::RequestTransactions,
            CalicodMessagePayloadType::IbdBlock,
            CalicodMessagePayloadType::InvRelayBlock,
            CalicodMessagePayloadType::InvTransactions,
            CalicodMessagePayloadType::Ping,
            CalicodMessagePayloadType::Pong,
            // CalicodMessagePayloadType::Verack,
            // CalicodMessagePayloadType::Version,
            // CalicodMessagePayloadType::Ready,
            CalicodMessagePayloadType::TransactionNotFound,
            CalicodMessagePayloadType::Reject,
            CalicodMessagePayloadType::PruningPointUtxoSetChunk,
            CalicodMessagePayloadType::RequestIbdBlocks,
            ...
            CalicodMessagePayloadType::RequestNextHeaders,
            CalicodMessagePayloadType::DoneHeaders,
            CalicodMessagePayloadType::RequestPruningPointUtxoSet,
            CalicodMessagePayloadType::RequestHeaders,
            CalicodMessagePayloadType::RequestBlockLocator,
            CalicodMessagePayloadType::PruningPoints,
            CalicodMessagePayloadType::RequestPruningPointProof,
            ...
            CalicodMessagePayloadType::RequestIbdChainBlockLocator,
            CalicodMessagePayloadType::IbdChainBlockLocator,
            CalicodMessagePayloadType::RequestAntipast,
    ...
    async fn call(&self, msg: pb::CalicodMessage) -> bool {
        // echo
...
fn build_dummy_version_message() -> VersionMessage {
    pb::VersionMessage {
        ...
        subnetwork_id: None,
        network: "calico-mainnet".to_string(),
    }
}
...
impl ConnectionInitializer for EchoFlowInitializer {
    async fn initialize_connection(&self, router: Arc<Router>) -> Result<(), ProtocolError> {
        //
        // Example code to illustrate calico P2P handshaking
        //

        // Build the handshake object and subscribe to handshake messages
        let mut handshake = CalicodHandshake::new(&router);
...
mod tests {
    ...
    use calico_utils::networking::NetAddress;

    #[tokio::test]
    async fn test_handshake() {
        calico_core::log::try_init_logger("debug");
