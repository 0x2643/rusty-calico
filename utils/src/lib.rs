...
//! # Calico Utilities
//!
//! General purpose utilities and various type extensions used across the Rusty Calico codebase.
//!
...
///     }
/// }
/// impl calico_utils::hex::FromHex for MyStruct {
...
///     }
/// }
/// calico_utils::serde_impl_ser_fixed_bytes_ref!(MyStruct, 20);
/// calico_utils::serde_impl_deser_fixed_bytes_ref!(MyStruct, 20);
///
...
/// #[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, serde::Deserialize)]
/// struct TestStruct {
///     #[serde(with = "calico_utils::serde_bytes_fixed_ref")]
///     v: MyStruct,
/// }
///
