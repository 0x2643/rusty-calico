...
/// This class accepts the master Calico XPrv string (e.g. `xprv1...`) and generates
...
///
/// Please note that in Calico master private keys use `kprv` prefix.
///
