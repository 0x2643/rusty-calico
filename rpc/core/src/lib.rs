//! # RPC Core
//!
//! This crate provides foundational primitives used in Rusty Calico node RPC subsystem.
...
//!
//! This crate acts as a foundation for [`calico_grpc_client`](https://docs.rs/calico_grpc_client) and
//! [`calico_wrpc_client`](https://docs.rs/calico_wrpc_client) crates, which provide gRPC and WebSocket
//! RPC client implementations. This crate is also used by WASM bindings to provide [WASM RpcClient
//! implementation](https://docs.rs/calico-wrpc-client/latest/calico_wrpc_client/wasm/struct.RpcClient.html)
//! (based on wRPC).
//!
