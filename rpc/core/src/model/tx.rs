...
use calico_utils::{hex::ToHex, serde_bytes_fixed_ref};
use serde::{Deserialize, Serialize};
use workflow_serializer::prelude::*;

use crate::prelude::{RpcHash, RpcScriptClass, RpcSubnetworkId};

/// Represents the ID of a Calico transaction
...
/// Represents a Calico transaction outpoint
...
impl From<calico_consensus_client::TransactionOutpoint> for RpcTransactionOutpoint {
    fn from(outpoint: calico_consensus_client::TransactionOutpoint) -> Self {
        TransactionOutpoint::from(outpoint).into()
    }
}

impl From<RpcTransactionOutpoint> for calico_consensus_client::TransactionOutpoint {
    fn from(outpoint: RpcTransactionOutpoint) -> Self {
        TransactionOutpoint::from(outpoint).into()
    }
}
...
/// Represents a Calico transaction input
...
/// Represent Calico transaction input verbose data
...
/// Represents a Calicod transaction output
#[derive(Clone, Debug, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// Represent Calico transaction output verbose data
#[derive(Clone, Debug, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// Represents a Calico transaction
#[derive(Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// Represent Calico transaction verbose data
#[derive(Clone, Debug, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
