...
//! the [`calico_consensus_client`], [`calico_consensus_core`]
//! and [`calico_wallet_psst`](crate) types.
//!
...
use calico_consensus_client::{Transaction, TransactionInput, TransactionInputInner, TransactionOutput, TransactionOutputInner};
use calico_consensus_core::tx as cctx;
