use crate::{
    error::{Error, Result},
    resolver::{CalicodResponseReceiver, CalicodResponseSender, Resolver},
};
...
impl Pending {
    fn new(sender: CalicodResponseSender) -> Self {
...
impl Resolver for IdResolver {
    fn register_request(&self, _: CalicodPayloadOps, request: &CalicodRequest) -> CalicodResponseReceiver {
