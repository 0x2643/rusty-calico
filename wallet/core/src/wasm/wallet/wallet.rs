...
use calico_wallet_macros::declare_typescript_wasm_interface as declare;
use calico_wasm_core::events::{get_event_targets, Sink};
use calico_wrpc_wasm::{IConnectOptions, Resolver, RpcClient, RpcConfig, WrpcEncoding};
...
///
/// The Rusty Calico is developed in Rust, and the Wallet class is a Rust implementation
