...
const calico = require('../calico/calico_wasm');
...
calico.init_console_panic_hook();
...
(async () => {
    ...
    //     extraData:[],
    //     payAddress:"calico:qrwee7xc2qw5whq8qzv82qjld6zunwy46lsy3hueej5kvgfwvamhswy03lsyh"
    // });
    ...
    const addr = address ?? "calicotest:qz7ulu4c25dh7fzec9zjyrmlhnkzrg4wmf89q7gzr3gfrsj3uz6xjceef60sd";

    const addresses = [
        addr,
        //new Address("calicotest:qz7ulu4c25dh7fzec9zjyrmlhnkzrg4wmf89q7gzr3gfrsj3uz6xjceef60sd")
    ];
    ...
    // let outputs = [
    //     new calico.TransactionOutput(300n, new calico.ScriptPublicKey(0, keypair3.publicKey)),
    //     {
    //         value: 300n,
    //         scriptPublicKey : new calico.ScriptPublicKey(0, keypair3.publicKey)
    //     },
    // ];
