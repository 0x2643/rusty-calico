...
pub const MAINNET_PARAMS: Params = Params {
    dns_seeders: &[
        ...
        "mainnet-dnsseed-1.calicocoin.org",
        "mainnet-dnsseed-2.calicocoin.org",
    ],
    ...
    // This is technically a soft fork from the Go implementation since calicod's consensus doesn't
...
pub const TESTNET_PARAMS: Params = Params {
    dns_seeders: &[
        // Official DNS seeders.
        "testnet-dnsseed-1.calicocoin.org",
        "testnet-dnsseed-2.calicocoin.org",
    ],
...
pub const TESTNET11_PARAMS: Params = Params {
    dns_seeders: &[
        // Official DNS seeders.
        "testnet11-dnsseed-1.calicocoin.org",
        "testnet11-dnsseed-2.calicocoin.org",
    ],
