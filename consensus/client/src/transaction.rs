//!
//! Declares the client-side [`Transaction`] type, which represents a Calico transaction.
//!
...
use calico_consensus_core::network::NetworkTypeT;
use calico_consensus_core::subnets::{self, SubnetworkId};
...
impl Transaction {
    ...
    pub fn addresses(&self, network_type: &NetworkTypeT) -> Result<calico_addresses::AddressArrayT> {
