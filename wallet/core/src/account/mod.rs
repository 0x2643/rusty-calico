...
pub mod pssb;
pub mod variants;
use calico_hashes::Hash;
use calico_wallet_psst::bundle::Bundle;
pub use kind::*;
use pssb::{
...
use calico_bip32::{ChildNumber, ExtendedPrivateKey, PrivateKey};
use calico_consensus_client::UtxoEntryReference;
use calico_wallet_keys::derivation::gen0::WalletDerivationManagerV0;
...
pub trait Account: AnySync + Send + Sync + 'static {
    ...
    ) -> Result<(GeneratorSummary, Vec<calico_hashes::Hash>)> {
    ...
    async fn pssb_broadcast(self: Arc<Self>, bundle: &Bundle) -> Result<Vec<Hash>, Error> {
        let mut ids = Vec::new();
        ...
        while let Some(result) = stream.next().await {
            match result {
                Ok(psst) => {
                    ...
                    let transaction = psst_to_pending_transaction(psst, self.wallet().network_id()?, change)?;
                    ids.push(transaction.try_submit(&self.wallet().rpc_api()).await?);
                }
                Err(e) => {
...
mod tests {
    ...
    use calico_bip32::secp256k1::SecretKey;
    use calico_bip32::PrivateKey;
    use calico_bip32::SecretKeyExt;
    use calico_wallet_keys::derivation::gen0::PubkeyDerivationManagerV0;
    use std::str::FromStr;

    fn gen0_receive_addresses() -> Vec<&'static str> {
        vec![
            "calicotest:qqnapngv3zxp305qf06w6hpzmyxtx2r99jjhs04lu980xdyd2ulwwddz54ywf",
            "calicotest:qqfwmv2jm7dsuju9wz27ptdm4e28qh6evfsm66uf2vf4fxmpxfqgyd7u8slr2",
            "calicotest:qpcerqk4ltxtyprv9096wrlzjx5mnrlw4fqce6hnl3axy7tkvyjxyhele5r8m",
            "calicotest:qr9m4h44ghmyz4wagktx8kgmh9zj8h8q0f6tc87wuad5xvzkdlwd62hzvx0dn",
            "calicotest:qrkxylqkyjtkjr5zs4z5wjmhmj756e84pa05amcw3zn8wdqjvn4tcwp04esy9",
            "calicotest:qp3w5h9hp9ude4vjpllsm4qpe8rcc5dmeealkl0cnxlgtj4ly7rczkdlqyutg",
            "calicotest:qpqen78dezzj4w7rae4n6kvahlr6wft7jy3lcul78709asxksgxc2qgzy3tae",
            "calicotest:qq7upgj3g8klaylc4etwhlmr70t24wu4n4qrlayuw44yd8wx40sej0peswdp4",
            "calicotest:qqt2jzgzwy04j8np6ne4g0akmq4gj3fha0gqupr2mjj95u5utzxqv66kkmxlh",
            "calicotest:qpcnt3vscphae5q8h576xkufhtuqvntg0ves8jnthgfaxy8ajek8z56443j2j",
            "calicotest:qz7wzgzvnadgp6v4u6ua9f3hltaa3cv8635mvzlepa63ttt72c6m2ev0c78g2",
            "calicotest:qpqtsd4flc0n4g720mjwk67tnc46xv9ns5xs2khyvlvszy584ej4xkw6qhzsw",
            "calicotest:qq4uy92hzh9eauypps060g2k7zv2xv9fsgc5gxkwgsvlhc7tw4a3gqly7clga",
            "calicotest:qqgfhd3ur2v2xcf35jggre97ar3awl0h62qlmmaaq28dfrhwzgjnx9q233rlg",
            "calicotest:qzuflj6tgzwjujsym9ap6dvqz9zfwnmkta68fjulax09clh8l4rfsfezlu55q",
            "calicotest:qz6645a8rrf0hmrdvyr9uj673lrr9zwhjvvrytqpjsjdet23czvc73772vcwj",
            "calicotest:qz2fvhmk996rmmg44ht0s79gnw647ehu8ncmpf3sf6txhkfmuzuxsxn79uhfy",
            "calicotest:qr9aflwylzdu99z2z25lzljyeszhs7j02zhfdazydgahq2vg6x8w79zxutm8t",
            "calicotest:qzen7nh0lmzvujlye5sv3nwgwdyew2zp9nz5we7pay65wrt6kfxd6quflynat",
            "calicotest:qq74jrja2mh3wn6853g8ywpfy9nlg0uuzchvpa0cmnvds4tfnpjj5at07eujz",
        ]
    }
    ...
    fn gen0_change_addresses() -> Vec<&'static str> {
        vec![
            "calicotest:qrc0xjaq00fq8qzvrudfuk9msag7whnd72nefwq5d07ks4j4d97kzdypuqyv8",
            "calicotest:qpf00utzmaa2u8w9353ssuazsv7fzs605eg00l9luyvcwzwj9cx0zrsq7uxne",
            "calicotest:qrkxek2q6eze7lhg8tq0qw9h890lujvjhtnn5vllrkgj2rgudl6xv8hvgtnuh",
            "calicotest:qrn0ga4lddypp9w8eygt9vwk92lagr55e2eqjgkfr09az90632jc69kurkzc5",
            "calicotest:qzga696vavxtrg0heunvlta5ghjucptll9cfs5x0m2j05s55vtl362uxs9fma",
            "calicotest:qq8ernhu26fgt3ap73jalhzl5u5zuergm9f0dcsa8uy7lmcx875hwf6y2ujw2",
            "calicotest:qrauma73jdn0yfwspr7yf39recvjkk3uy5e4309vjc82qq7sxtskjhu0r9ghd",
            "calicotest:qzk7yd3ep4def7sv7yhl8m0mr7p75zclycrv0x0jfm0gmwte23k0uzzzqpc90",
            "calicotest:qzvm7mnhpkrw52c4p85xd5scrpddxnagzmhmz4v8yt6nawwzgjtav2vjyjqqd",
            "calicotest:qq4feppacdug6p6zk2xf4rw400ps92c9h78gctfcdlucvzzjwzyz7y3nz2fnp",
            "calicotest:qryepg9agerq4wdzpv39xxjdytktga53dphvs6r4fdjc0gfyndhk7jqx7xnv8",
            "calicotest:qpywh5galz3dd3ndkx96ckpvvf5g8t4adaf0k58y4kgf8w06jt5myygxj9t33",
            "calicotest:qq32grys34737mfe5ud5j2v03cjefynuym27q7jsdt28qy72ucv3s6yv5efts",
            "calicotest:qper47ahktzf9lv67a5e9rmfk35pq4xneufhu97px6tlzd0d4qkakfdekgwe9",
            "calicotest:qqal0t8w2y65a4lm5j5y4maxyy4nuwxj6u364eppj5qpxz9s4l7tk9zfz9ay6",
            "calicotest:qr7p66q7lmdqcf2vnyus38efx3l4apvqvv5sff66n808mtclef2w76dsuyw5c",
            "calicotest:qqx4xydd58qe5csedz3l3q7v02e49rwqnydc425d6jchv02el2gdvryne4sg0",
            "calicotest:qzyc9l5azcae7y3yltgnl5k2dzzvngp90a0glsepq0dnz8dvp4jyv0j9veh7v",
            "calicotest:qq705x6hl9qdvr03n0t65esevpvzkkt2xj0faxp6luvd2hk2gr76cpdf2lsrl",
            "calicotest:qzufchm3cy2ej6f4cjpxpnt3g7c2gn77c320qhrnrjqqskpn7vnzstd0hmg3x",
        ]
    }
