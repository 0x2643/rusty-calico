...
use calico_consensus_client::{sign_with_multiple_v3, Transaction};
use calico_consensus_core::hashing::wasm::SighashType;
use calico_consensus_core::sign::sign_input;
use calico_consensus_core::tx::PopulatedTransaction;
use calico_consensus_core::{hashing::sighash_type::SIG_HASH_ALL, sign::verify};
use calico_hashes::Hash;
use calico_wallet_keys::privatekey::PrivateKey;
use calico_wasm_core::types::HexString;
use js_sys::Array;
