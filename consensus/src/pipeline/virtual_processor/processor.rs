...
use calico_consensusmanager::SessionLock;
use calico_core::{debug, info, time::unix_now, trace, warn};
use calico_database::prelude::{StoreError, StoreResultEmptyTuple, StoreResultExtensions};
use calico_hashes::Hash;
use calico_muhash::MuHash;
use calico_notify::{events::EventType, notifier::Notify};

use super::errors::{PruningImportError, PruningImportResult};
use calico_consensus_core::tx::ValidatedTransaction;
use calico_utils::binary_heap::BinaryHeapExtensions;
...
impl VirtualStateProcessor {
    ...
    pub(crate) fn build_block_template_from_virtual_state(
        ...
        let accepted_id_merkle_root = calico_merkle::calc_merkle_root(virtual_state.accepted_tx_ids.iter().copied());
