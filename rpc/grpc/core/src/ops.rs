use crate::protowire::{calicod_request::Payload as RequestPayload, calicod_response::Payload as ResponsePayload, *};
...
pub enum CalicodPayloadOps {
    ...
    // The conversion from a notification ResponsePayload into CalicodPayloadOps fails.
}
}
