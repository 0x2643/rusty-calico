//! PSST input structure.

use crate::psst::{KeySource, PartialSigs};
...
pub struct Input {
    ...
    #[serde(with = "calico_utils::serde_bytes_optional")]
    #[builder(setter(strip_option))]
...
pub enum CombineError {
    ...
    SpentOutputIndexMismatch {
        /// Attempted to combine a PSST with `this` spent output index.
        this: u32,
