...
use calico_consensus_core::hashing::sighash::SigHashReusedValues;
use calico_consensus_core::hashing::sighash_type::SigHashType;
...
opcode_list! {
    ...
    opcode OpIf<0x63, 1>(self, vm) {
        ...
        if vm.is_executing() {
            ...
            // the similar flow of go-calicod
...
mod test {
    ...
    use calico_consensus_core::constants::{SOMPI_PER_CALICO, TX_VERSION};
    ...
    fn make_mock_transaction(lock_time: u64) -> (VerifiableTransactionMock, TransactionInput, UtxoEntry) {
        ...
        let dummy_tx_out = TransactionOutput::new(SOMPI_PER_CALICO, dummy_script_public_key);
