...
macro_rules! trace {
    ($($t:tt)*) => {
        if calico_core::log::workflow_log::log_level_enabled(log::Level::Trace) {
            calico_core::log::workflow_log::impls::trace_impl(None, &format_args!($($t)*));
        }
    };
}
...
macro_rules! debug {
    ($($t:tt)*) => (
        if calico_core::log::workflow_log::log_level_enabled(log::Level::Debug) {
            calico_core::log::workflow_log::impls::debug_impl(None, &format_args!($($t)*));
        }
    )
}
...
macro_rules! info {
    ($($t:tt)*) => (
        if calico_core::log::workflow_log::log_level_enabled(log::Level::Info) {
            calico_core::log::workflow_log::impls::info_impl(None, &format_args!($($t)*));
        }
    )
}
...
macro_rules! warn {
    ($($t:tt)*) => (
        if calico_core::log::workflow_log::log_level_enabled(log::Level::Warn) {
            calico_core::log::workflow_log::impls::warn_impl(None, &format_args!($($t)*));
        }
    )
}
...
macro_rules! error {
    ($($t:tt)*) => (
        if calico_core::log::workflow_log::log_level_enabled(log::Level::Error) {
            calico_core::log::workflow_log::impls::error_impl(None, &format_args!($($t)*));
        }
    )
}
