//!
//! Partially Signed Calico Transaction (PSST)
//!

use calico_bip32::{secp256k1, DerivationPath, KeyFingerprint};
...
use calico_consensus_core::tx::UtxoEntry;
...
use calico_txscript::{caches::Cache, TxScriptEngine};
...
pub struct KeySource {
    #[serde(with = "calico_utils::serde_bytes_fixed")]
...
///
/// A Partially Signed Calico Transaction (PSST) is a standardized format
/// that allows multiple participants to collaborate in creating and signing
/// a Calico transaction. PSST enables the exchange of incomplete transaction
