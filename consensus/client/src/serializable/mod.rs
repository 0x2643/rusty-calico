//!
//! # Standardized JSON serialization and deserialization of Calico transactions.
//!
//! This module provides standardized JSON serialization and deserialization of
//! Calico transactions. There are two sub-modules: `numeric` and `string`.
//!
...
//! For more advanced use cases, please refer to `PSST` in the [`calico_wallet_psst`](https://docs.rs/calico_wallet_psst)
//! crate.
//!
