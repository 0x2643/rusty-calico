...
use calico_hashes::{Hash, PersonalMessageSigningHash};
...
mod tests {
    ...
    fn test_basic_sign_and_verify_sign() {
        let pm = PersonalMessage("Hello Calico!");
        let privkey: [u8; 32] = [
...
Ut omnis magnam et accusamus earum rem impedit provident eum commodi repellat qui dolores quis et voluptate labore et adipisci deleniti. Est nostrum explicabo aut quibusdam labore et molestiae voluptate. Qui omnis nostrum At libero deleniti et quod quia.");
    ...
    #[test]
    fn test_fail_verify() {
        let pm = PersonalMessage("Not Hello Calico!");
        let pubkey = XOnlyPublicKey::from_slice(&[
            0xF9, 0x30, 0x8A, 0x01, 0x92, 0x58, 0xC3, 0x10, 0x49, 0x34, 0x4F, 0x85, 0xF8, 0x9D, 0x52, 0x29, 0xB5, 0x31, 0xC8, 0x45,
            0x83, 0x6F, 0x99, 0xB0, 0x86, 0x01, 0xF1, 0x13, 0xBC, 0xE0, 0x36, 0xF9,
        ])
    ...
    fn test_sign_and_verify_test_case_0() {
        ...
        let expected_sig: Vec<u8> = [
            0x23, 0xF0, 0xFF, 0x26, 0x57, 0xB7, 0x9F, 0x4C, 0x25, 0x58, 0xF3, 0x34, 0x22, 0x31, 0x47, 0xF9, 0x27, 0x76, 0x61, 0x91,
            0xFE, 0x2B, 0x01, 0x68, 0x85, 0x7B, 0x66, 0x0E, 0x7C, 0x49, 0x6F, 0x62, 0xDA, 0x1B, 0x79, 0xB1, 0x28, 0xB6, 0x4A, 0xD1,
            0x05, 0xDC, 0x00, 0x20, 0xD4, 0x02, 0x19, 0x17, 0x03, 0x23, 0x62, 0x07, 0x53, 0xE4, 0x6F, 0xA1, 0x47, 0x6A, 0x4B, 0xEC,
            0x1A, 0x12, 0xDC, 0x0B,
        ]
        .to_vec();
    ...
    fn test_sign_and_verify_test_case_1() {
        ...
        .unwrap();
        let expected_sig: Vec<u8> = [
            0xAC, 0x79, 0x0E, 0xCC, 0xC1, 0xBC, 0x27, 0x85, 0xE4, 0x1E, 0x19, 0xF8, 0x83, 0xF7, 0x7A, 0x66, 0x5A, 0x59, 0x89, 0x60,
            0xCE, 0x0E, 0xEF, 0x9F, 0x57, 0x1D, 0xBF, 0x9F, 0x51, 0xAD, 0x4E, 0x58, 0xA6, 0x21, 0x36, 0x69, 0x0C, 0x0F, 0x0A, 0x6A,
            0x93, 0x12, 0xAA, 0x1A, 0x93, 0xA2, 0x5A, 0xA5, 0x03, 0xCE, 0x7F, 0xDC, 0xD9, 0xFD, 0x35, 0x52, 0xF3, 0xC4, 0x9C, 0x42,
            0x6F, 0xC5, 0x8A, 0x6F,
        ]
        .to_vec();
