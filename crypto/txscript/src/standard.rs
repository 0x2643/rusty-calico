...
use calico_consensus_core::tx::{ScriptPublicKey, ScriptVec};
    ...
    fn test_extract_address_and_encode_script() {
        ...
        let tests = vec![
            Test {
                ...
                expected_address: Ok("calico:qpauqsvk7yf9unexwmxsnmg547mhyga37csh0kj53q6xxgl24ydxjfnfxm0f4".try_into().unwrap()),
            },
            Test {
                ...
                expected_address: Ok("calicotest:qxaqrlzlf6wes72en3568khahq66wf27tuhfxn5nytkd8tcep2c0vrsgklux69f".try_into().unwrap()),
            },
            Test {
