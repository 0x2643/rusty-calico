...
use calico_p2p_lib::{
    make_message,
    pb::{calicod_message::Payload, CalicodMessage, InvTransactionsMessage},
    Hub,
};
...
impl TransactionsSpread {
    ...
    /// capacity.
    ///
    /// _GO-CALICOD: EnqueueTransactionIDsForPropagation_
    ...
    async fn broadcast(&self, msg: CalicodMessage, should_throttle: bool) {
        if should_throttle {
